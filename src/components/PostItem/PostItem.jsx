  ...
  return (
    <div className='flex pt-8 justify-between items-center gap-2 sm:gap-4 md:gap-8 xl:gap-12'>
      <Link to={`posts/${id}`} className='py-4'>
        <article className='space-y-2 w-full xl:grid xl:grid-cols-3 xl:items-center xl:justify-start xl:space-x-2 xl:space-y-0'>
          <dl className='flex items-center gap-4 xl:flex-col xl:items-start'>
          ...
          <dl className='text-2xl font-bold leading-8 tracking-tight '>
          ...
          <div className='pt-4 xl:pt-0 max-w-none text-gray-500 capitalize'>
